                ...
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.php">
                      ...
                      <span class="hidden-xs">
                        <!--This is light logo text--><img src="https://ikontel.com/assets/images/ikontel-logo.png" alt="home" class="light-logo" width="70%" />
                     </span> </a>
                </div>
                <!-- /Logo -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="pageSeo.php" class="waves-effect"><i class="fa fa-tags fa-fw"
                                aria-hidden="true"></i>Page SEO</a>
                    </li>
                   
                </ul>
                <div class="center p-20">
                    <a href="../../" target="_blank" class="btn btn-danger btn-block waves-effect waves-light">Vist site</a>
                </div>
            </div>
