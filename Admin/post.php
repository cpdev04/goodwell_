            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <div class="form-group">
                            ...
                            <input name="pageTitle" type="text" class="form-control rounded" placeholder="Page Title"
                                required>
                        </div>
                        <div class="form-group">
                            <?php echo (isset($PostTitleError)) ? $PostTitleError : ""; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input name="MetaTitle" type="text" class="form-control rounded" placeholder="Meta Title">
                        </div>
                        <div class="form-group">
                            <?php echo (isset($PostSlugError)) ? $PostSlugError : ""; ?>
                            <label for="MetaDesc">Meta Description:</label>
                            <input name="MetaDesc" type="text" class="form-control rounded" placeholder="Meta Description">
                        </div>
                        <div class="form-group">
                            <?php echo (isset($PostSlugError)) ? $PostSlugError : ""; ?>
                            <label for="MetaKey">Meta Keyword:</label>
                            <input name="MetaKey" type="text" class="form-control rounded" placeholder="Meta Keyword">
                        </div>
                        <!-- Meta -->
                        <div class="form-group">
