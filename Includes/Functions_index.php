    ...
    if($Result->num_rows > 0){
        while ($Row = $Result->fetch_assoc()){
            ...
            <div class="w3-container">
                <h3 style="height:145px;overflow:hidden;position: relative;"><b style="color:black;text-transform:none;">' . $PostTitle . '</b></h3>
...
function DisplayPost($PostID) {
    ...
    if ($Result->num_rows > 0) {
        while ($Row = $Result->fetch_assoc()) {
            ...
            $PostContent = preg_replace('/<ul>/', '<ul class="ultype">', $PostContent);
            $PostContent = preg_replace('/<ol>/', '<ol class="oltype">', $PostContent);
    ...
    if ($Result->num_rows > 0) {
        ...
        while ($Row = $Result->fetch_assoc()) {
            ...
            <div class="comment-container" style="display:flex;" >
                <img src="https://childcentralclinic.com/assets/img/thumb/testimonal_mal.jpeg" alt="Avatar"style="width:40px;height:40px;" class="avatar">
